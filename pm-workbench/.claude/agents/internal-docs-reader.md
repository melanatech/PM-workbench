...
description: Use whenever a task needs grounding from durable internal documents - user research reports, wiki pages beyond Jira/support (strategy docs, decision records), shared-drive files, or anything sitting in the local file browser. General-purpose - dispatched alongside a command's more specific subagent, not a replacement for it.
