...
Input: $ARGUMENTS (typed, dictated as a voice memo, or pasted from a Teams/Copilot summary — see below)
...
**If this is a meeting you organized in Teams:** its auto-transcript/AI summary is usually richer than what you'd type by hand — worth grabbing if you have 20 extra seconds, but don't let waiting for it delay this command.
